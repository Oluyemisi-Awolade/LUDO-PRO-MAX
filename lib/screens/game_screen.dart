              ...
              Row(children: [
                Expanded(
                  child: ElevatedButton(
                    onPressed: () {
                      // Diagnostic: prove the tap is actually reaching this
                      // button before anything else runs.
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
                          content: Text('Play Again tapped'),
                          duration: Duration(milliseconds: 900),
                          backgroundColor: Colors.blue,
                        ),
                      );
                      // Pop first and let this frame fully complete before
                      // doing anything else, so nothing can interfere with
                      // the dialog actually closing. If setupGame() throws
                      // for any reason, surface it instead of failing silently.
