...
class _GameScreenState extends ConsumerState<GameScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final isMyTurn    = gs.isPlayerTurn;
    final canRoll     = isMyTurn && !gs.diceRolled && !gs.gameOver;
    final audio       = ref.read(audioServiceProvider);

        // Roll button label/color
    String rollLabel;
    Color  rollColor;
    if (gs.gameOver) {
              ...
              child: Row(
                children: [
                  ...
                  IconButton(
                    ...
                    onPressed: () => setState(() => audio.sfxEnabled = !audio.sfxEnabled),
                  ),
                  // BGM toggle
                  IconButton(
                    icon: Icon(
                    ...
                    onPressed: () {
                      ...
                      if (audio.bgmEnabled) audio.startBgm(); else audio.stopBgm();
                    },
                  ),
            ...
            Container(
              ...
              child: ListView.separated(
                ...
                itemBuilder: (_, i) => GestureDetector(
                  onTap: () => ref.read(gameProvider.notifier).sendChat(kEmotes[i]),
                  child: Container(
                    width: 36, height: 32,
                    ...
                    child: Text(kEmotes[i], style: const TextStyle(fontSize: 16)),
                  ),
                ),
              ),
            ),
            ...
            children: [
              ...
              IconButton(
                ...
                onPressed: () {
                  ...
                  ref.read(gameProvider.notifier).sendChat(chatCtrl.text.trim());
                  chatCtrl.clear();
                },
              ),
            ],
